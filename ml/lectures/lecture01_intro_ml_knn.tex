...
\pause
\begin{rlintuition}
Use rule-based control in structured environments; use ML when recognition under variation is the main challenge.
\end{rlintuition}
\end{frame}

\begin{frame}{Manufacturing Example: Rule-based vs Machine Learning}
\centering
\includegraphics[height=5.5cm]{figures/intro/manufacturing_rule_vs_ml.pdf}
...
\centering
\includegraphics[height=3.5cm]{figures/knn/knn_scaling_effect.pdf}
...
\centering
\includegraphics[height=5.5cm]{figures/knn/knn_indexing_tradeoff.pdf}
